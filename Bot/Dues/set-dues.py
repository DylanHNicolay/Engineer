...
class SetDues(commands.Cog):
    ...
    @app_commands.command(
        name="set_dues_starters", description="Set the dues amount for starters."
    )
    ...
    async def set_dues_starters(self, interaction: discord.Interaction, amount: int):
        ...
        try:
            ...
            if rows:
                ...
                await db.execute(
                    "INSERT INTO dues (starters, substitues, non_player) VALUES ($1, 0, 0)",
                    amount,
                )
    ...
    @app_commands.command(
        name="set_dues_substitutes", description="Set the dues amount for substitutes."
    )
    ...
    async def set_dues_substitutes(self, interaction: discord.Interaction, amount: int):
        ...
        try:
            ...
            if rows:
                ...
                await db.execute(
                    "INSERT INTO dues (starters, substitues, non_player) VALUES (0, $1, 0)",
                    amount,
                )
    ...
    @app_commands.command(
        name="set_dues_non_players", description="Set the dues amount for non-players."
    )
    ...
    async def set_dues_non_players(self, interaction: discord.Interaction, amount: int):
        ...
        try:
            ...
            if rows:
                ...
                await db.execute(
                    "INSERT INTO dues (starters, substitues, non_player) VALUES (0, 0, $1)",
                    amount,
                )
